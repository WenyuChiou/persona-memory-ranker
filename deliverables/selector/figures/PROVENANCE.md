...
No Apersona private screenshots or diagrams were used. Images explain the implemented research design and do not depict measured human outcomes. The figures are raster images embedded in PowerPoint; surrounding text, chart data and speaker notes remain editable.
